        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-lg">
              ...
              <p className="mt-4 text-slate-400 leading-relaxed">
                ...
                desenvolvo forte capacidade de comunicação, organização e foco
                em resultados. Ao longo dessa experiência, passo a estruturar
                processos e criar workflows que aumentam eficiência operacional
                e conversão.
              </p>

              <p className="mt-4 text-slate-400 leading-relaxed">
                Com a transição para tecnologia, começo a aplicar esses mesmos
                princípios no desenvolvimento de sistemas, criando aplicações
                com arquitetura organizada, integração de dados e automação de
                processos.
              </p>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-lg">
              ...
              <ul className="mt-4 space-y-4 text-slate-400">
                ...
                <li>
                  Busco sempre conectar tecnologia com impacto real, seja em
                  performance, automação ou experiência do usuário.
                </li>
              </ul>
            </div>
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-lg">
              ...
              <p className="mt-4 text-slate-400 leading-relaxed">
                Busco oportunidades de estágio onde eu possa evoluir
                tecnicamente e ao mesmo tempo contribuir com soluções práticas,
                principalmente em ambientes que envolvam automação, dados e
                melhoria de processos.
              </p>

              <p className="mt-4 text-slate-400 leading-relaxed">
                Tenho interesse especial em atuar em contextos próximos a
                operações, onde tecnologia pode gerar eficiência e escala.
              </p>
            </div>
          </div>
          ...
          <div className="mt-20 rounded-2xl border border-slate-700/60 bg-[#111827]/90 p-10 text-center">
            ...
            <p className="mt-4 text-slate-400">
              Estou aberto a oportunidades de estágio e projetos em tecnologia.
            </p>
